...
retcode = subprocess.call("wsl ldc2 -mtriple=thumb-none-eabi -g -float-abi=hard -mcpu=cortex-m4 -c -betterC -singleobj -boundscheck=off -I=src -O2 -of=build/main.o src/main.d src/lcd.d src/delay.d src/pong.d", shell=True)
if retcode != 0:
